...
2025년 10월부터 11월까지 진행한 SSAFY 팀 프로젝트입니다. 사용자는 발성, 단어, 문장 훈련을 수행하고 연습 기록과 피드백을 확인할 수 있습니다. 저는 프론트엔드 개발을 맡아 발성 훈련과 브라우저 녹음 처리, API 구조 개선을 담당했습니다.
